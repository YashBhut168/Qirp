      ...
      body: SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              sizeBoxHeight(10),
              widget.homeCategoryData!.type == 'artist'
                  ? GridView.builder(
                      ...
                      itemCount: widget.homeCategoryData!.categoryData!
                        ...
                        return GestureDetector(
                          onTap: () {
                            ...
                            artistScreenController.artistsSongsList(
                                artistId: widget.homeCategoryData!
                                    .categoryData![index].artistId!);
                            Get.to(
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl: (widget.homeCategoryData!.categoryData![index].image!),
                              ...
                              sizeBoxHeight(10),
                              lable(
                                  text: (widget.homeCategoryData!.categoryData![index].title)!,
                                  fontSize: 12,
                                  color: AppColors.white),
                              sizeBoxHeight(10),
                            ],
                  ...
                  : 
                  widget.homeCategoryData!.type == 'album' ?  
                     GridView.builder(
                          scrollDirection: Axis.vertical,
                          shrinkWrap: true,
                          physics: const BouncingScrollPhysics(),
                          gridDelegate:
                            ...
                            childAspectRatio: 83 / 81,
                            crossAxisSpacing: 0,
                            mainAxisSpacing: 0, // spacing between columns
                          ),
                            ...
                            return GestureDetector(
                              onTap: () {
                                albumScreenController.albumsSongsList(
                                  albumId: widget.homeCategoryData!
                                      .categoryData![index].albumId!);
                              Get.to(
                                        ...
                                        child: Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              lable(
                                                text: "${widget.homeCategoryData!.categoryData![index].songCount!} songs",
                                                  fontWeight: FontWeight.w600,
                                                  fontSize: 11,
                                                  color: Colors.grey,
                                                ),
                  ...
                  :
                  widget.homeCategoryData!.type == 'playlist' ?
                    GridView.builder(
                          scrollDirection: Axis.vertical,
                          shrinkWrap: true,
                          physics: const BouncingScrollPhysics(),
                          ...
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: () {
                                setState(() {
                                GlobVar.playlistId = widget.homeCategoryData!
                                    .categoryData![index].playlistId!;
                                GlobVar.adminOrUserPlaylist = 'admin';
                                GlobVar.adminPlaylistTapped = 'false';
                              });
                              log('${widget.homeCategoryData!.categoryData![index].playlistId}',
                                  name: 'playlistId');
                              Get.to(
                                PlaylistSongsScreen(
                                  screen: 'home',
                                  playlistTitle: widget.homeCategoryData!
                                      .categoryData![index].title!,
                                  myPlaylistData: widget
                                      .homeCategoryData!.categoryData![index],
                                  myPlaylistId: widget.homeCategoryData!
                                      .categoryData![index].playlistId!,
                                  myPlaylistImage: widget.homeCategoryData!
                  ...
                  ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        log(controller.categoryAudioUrl.toString(),
                            name: 'see all url');
                        return GestureDetector(
                          onTap: () async {
                            // if (widget.homeCategoryData!.type == 'song') {
                              setState(() {
                                ...
                                controller.currentListTileIndexCategoryData
                                    .value = index;
                                log("${controller.currentListTileIndexCategoryData.value}",
                                    name: 'see all current index');
                                log("${controller.currentListTileIndexCategory.value}",
                                    name: 'see all current category index');
                                        ...
                                        : (controller.isMiniPlayerOpenHome.value == true && homeScreenController.homeCategoryData[controller.currentListTileIndexCategory.value].categoryData[controller.currentListTileIndexCategoryData.value].title == categoryListData.title) ||
                                                ...
                                                (controller.isMiniPlayerOpenArtistSongs.value == true &&
                                                    ...
                                                    artistScreenController.allSongsListModel !=
                                                        null) ||
                                                (controller.isMiniPlayerOpenSearchSongs.value == true &&
                                                    searchScreenController.allSearchModel!.data![controller.currentListTileIndexSearchSongs.value].title == categoryListData.title &&
                                                    searchScreenController.allSearchModel != null) ||
                                                (controller.isMiniPlayerOpenQueueSongs.value == true && queueSongsScreenController.allSongsListModel!.data![controller.currentListTileIndexQueueSongs.value].title == categoryListData.title && queueSongsScreenController.allSongsListModel != null) ||
                                                (controller.isMiniPlayerOpenAdminPlaylistSongs.value == true && playlistScreenController.currentPlayingAdminTitle.value == categoryListData.title && playlistScreenController.adminPlaylistSongModel != null) ||
                                                ...
                                                (controller.isMiniPlayerOpenAlbumSongs.value == true && albumScreenController.allSongsListModel != null && albumScreenController.currentPlayingTitle.value == categoryListData.title) ||
                                      ...
                                      child: (controller.isMiniPlayerOpenDownloadSongs.value == false &&
                                          ...
                                          : (((controller.isMiniPlayerOpenHome.value == true && homeScreenController.homeCategoryData[controller.currentListTileIndexCategory.value].categoryData[controller.currentListTileIndexCategoryData.value].title == categoryListData.title) ||
                                                      ...
                                                      (controller.isMiniPlayerOpenSearchSongs.value == true &&
                                                          ...
                                                          searchScreenController.allSearchModel != null) ||
                                                      (controller.isMiniPlayerOpenAdminPlaylistSongs.value == true && playlistScreenController.currentPlayingAdminTitle.value == categoryListData.title && playlistScreenController.adminPlaylistSongModel != null) ||
                                                      (controller.isMiniPlayerOpenArtistSongs.value == true && artistScreenController.currentPlayingTitle.value == categoryListData.title && artistScreenController.allSongsListModel != null) ||
                                                      (controller.isMiniPlayerOpenQueueSongs.value == true && queueSongsScreenController.allSongsListModel!.data![controller.currentListTileIndexQueueSongs.value].title == categoryListData.title && queueSongsScreenController.allSongsListModel != null) ||
                                                      (controller.isMiniPlayerOpenAllSongs.value == true && allSongsScreenController.allSongsListModel != null && allSongsScreenController.allSongsListModel!.data![controller.currentListTileIndexAllSongs.value].title == categoryListData.title) ||
                                                      (controller.isMiniPlayerOpenFavoriteSongs.value == true && favoriteSongScreenController.allSongsListModel != null && favoriteSongScreenController.allSongsListModel!.data![controller.currentListTileIndexFavoriteSongs.value].title == categoryListData.title) ||
                                                      (controller.isMiniPlayerOpenFavoriteSongs.value == true && favoriteSongScreenController.allSongsListModel != null && favoriteSongScreenController.allSongsListModel!.data![controller.currentListTileIndexFavoriteSongs.value].title == categoryListData.title) ||
                                    ...
                                    : (controller.isMiniPlayerOpenHome.value == true && homeScreenController.homeCategoryData[controller.currentListTileIndexCategory.value].categoryData[controller.currentListTileIndexCategoryData.value].title == categoryListData.title) ||
                                            ...
                                            (controller.isMiniPlayerOpenSearchSongs.value == true &&
                                                ...
                                                searchScreenController.allSearchModel !=
                                                    null) ||
                                            (controller.isMiniPlayerOpenArtistSongs.value == true &&
                                                artistScreenController.currentPlayingTitle.value == categoryListData.title &&
