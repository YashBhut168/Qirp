                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      controller.addCategory1AudioUrlToList(
                                          file.existsSync()
                                              ...
                                              : (categoryData1!
                                                  .data![index].audio)!);
                                      controller.category1AudioUrl = controller
                                          .category1AudioUrl
                                          .toSet()
                                          .toList();
                                      return GestureDetector(
                                        onTap: () async {
                                          ...
                                          setState(() {
                                            ...
                                            // controller.audioPlayer!.audioSource;
                                            controller
                                            ...
                                            // controller.audioPlayer!.currentIndexStream
                                            //     .listen((index) {
                                            //     controller
                                            //         .currentListTileIndexCategory1
                                            //         .value = index!;
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      controller.addCategory2AudioUrlToList(
                                          file.existsSync()
                                              ? localFilePath
                                              : (categoryData2!.data![index].audio)!);
                                      ...
                                      return GestureDetector(
                                        onTap: () async {
                                          homeScreenController
                                              .updateCategoryData(categoryData2!);
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      controller.addCategory3AudioUrlToList(
                                          file.existsSync()
                                              ? localFilePath
                                              : (categoryData3!.data![index].audio)!);
                                      ...
                                      return GestureDetector(
                                        onTap: () async {
                                          homeScreenController
                                              .updateCategoryData(categoryData3!);
                                          ...
                                          await prefs.setInt('category3Index', index);
                                          homeScreenController.addRecentSongs(
                                              musicId:
                                                  categoryData3!.data![index].id!);
                                          // Get.to(
                                          //   DetailScreen(
                                          //     index: index,
                                          //     type: 'home',
