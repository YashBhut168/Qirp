  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Obx(
          () => lable(
            text: artistScreenController.isLoading.value == true
                ? AppStrings.artistSongs
                : artistScreenController.allSongsListModel!.message!,
            fontSize: 20,
      ...
      body: Obx(() => artistScreenController.isLoading.value == true
          ...
          : artistScreenController.artistSongsData.isEmpty
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      lable(
                          text:
                              "Sorry, the list of artist songs is currently unavailable."),
                    ],
                  ),
                )
                    ...
                    child: Column(
                      children: [
                        ...
                        ListView.builder(
                          ...
                          shrinkWrap: true,
                          itemCount:
                              artistScreenController.artistSongsData.length,
                          itemBuilder: (context, index) {
                            var artistsSongsData =
                                artistScreenController.artistSongsData[index];
                            final localFilePath =
                                '${AppStrings.localPathMusic}/${artistScreenController.allSongsListModel!.data![index].id}.mp3';
                            final file = File(localFilePath);
                            controller.addArtistSongsAudioUrlToList(
                                file.existsSync()
                                    ? localFilePath
                                    : (artistScreenController.allSongsListModel!
                                        .data![index].audio)!);
                            controller.artistSongsUrl =
                                controller.artistSongsUrl.toSet().toList();
                            log("artistSongsUrl---> ${controller.artistSongsUrl}");
                            return Column(
                              children: [
                                ListTile(
                                  onTap: () {
                                    setState(() {
                                      ...
                                      controller.isMiniPlayerOpenAllSongs
                                          .value = false;
                                      controller.currentListTileIndexArtistSongs
                                          .value = index;
                                      controller
                                          .updateCurrentListTileIndexArtistSongs(
                                              index);
                                      ...
                                      log(
                                          controller
                                              .currentListTileIndexArtistSongs
                                              .value
                                              .toString(),
                                          name:
                                              'currentListTileIndexArtistSongs');
                                      ...
                                      Obx(
                                        () => ClipRRect(
                                          ...
                                          child: (controller.isMiniPlayerOpenDownloadSongs.value == false &&
                                              ...
                                              : (controller.isMiniPlayerOpenArtistSongs.value == true && artistScreenController.currentPlayingTitle.value == artistScreenController.allSongsListModel!.data![index].title && artistScreenController.allSongsListModel != null) ||
                                                      ...
                                                      (controller.isMiniPlayerOpen.value == true &&
                                                          GlobVar.playlistId != '' &&
                                                          playlistScreenController.allSongsListModel!.data![controller.currentListTileIndex.value].title == artistScreenController.allSongsListModel!.data![index].title &&
                                                          playlistScreenController.allSongsListModel != null) ||
                                                      (controller.isMiniPlayerOpenAdminPlaylistSongs.value == true && playlistScreenController.currentPlayingAdminTitle.value == artistScreenController.allSongsListModel!.data![index].title && playlistScreenController.adminPlaylistSongModel != null) ||
                                                      (controller.isMiniPlayerOpenHome.value == true && homeScreenController.homeCategoryData[controller.currentListTileIndexCategory.value].categoryData[controller.currentListTileIndexCategoryData.value].title == artistScreenController.allSongsListModel!.data![index].title && homeScreenController.homeCategoryData.isNotEmpty) ||
                                                      (controller.isMiniPlayerOpenFavoriteSongs.value == true && favoriteSongScreenController.allSongsListModel!.data!.isNotEmpty && favoriteSongScreenController.allSongsListModel != null && favoriteSongScreenController.allSongsListModel!.data![controller.currentListTileIndexFavoriteSongs.value].title == artistScreenController.allSongsListModel!.data![index].title) ||
                                                      (controller.isMiniPlayerOpenQueueSongs.value == true && queueSongsScreenController.allSongsListModel!.data![controller.currentListTileIndexQueueSongs.value].title == artistScreenController.allSongsListModel!.data![index].title && queueSongsScreenController.allSongsListModel != null) ||
                                                      (controller.isMiniPlayerOpenSearchSongs.value == true && searchScreenController.allSearchModel!.data![controller.currentListTileIndexSearchSongs.value].title == artistScreenController.allSongsListModel!.data![index].title && searchScreenController.allSearchModel != null) ||
                                                      (controller.isMiniPlayerOpenAllSongs.value == true && allSongsScreenController.allSongsListModel != null && allSongsScreenController.allSongsListModel!.data![controller.currentListTileIndexAllSongs.value].title == artistScreenController.allSongsListModel!.data![index].title)
                                                  ? Opacity(
                                                      opacity: 0.4,
                                            ...
                                            child: Center(
                                              child: (controller.isMiniPlayerOpenDownloadSongs.value == false &&
                                                  ...
                                                  : (((controller.isMiniPlayerOpenArtistSongs.value == true &&
                                                              ...
                                                              (controller.isMiniPlayerOpenAdminPlaylistSongs.value == true && playlistScreenController.currentPlayingAdminTitle.value == artistScreenController.allSongsListModel!.data![index].title && playlistScreenController.adminPlaylistSongModel != null) ||
                                                              (controller.isMiniPlayerOpenSearchSongs.value == true && searchScreenController.allSearchModel!.data![controller.currentListTileIndexSearchSongs.value].title == artistScreenController.allSongsListModel!.data![index].title && searchScreenController.allSearchModel != null) ||
                                                              (controller.isMiniPlayerOpenAlbumSongs.value == true && albumScreenController.currentPlayingTitle.value == artistScreenController.allSongsListModel!.data![index].title && albumScreenController.allSongsListModel != null) ||
                                                              (controller.isMiniPlayerOpenDownloadSongs.value == true && downloadSongScreenController.allSongsListModel!.data![controller.currentListTileIndexDownloadSongs.value].title == artistScreenController.allSongsListModel!.data![index].title && downloadSongScreenController.allSongsListModel != null) ||
                                                              (controller.isMiniPlayerOpen.value == true && GlobVar.playlistId != '' && playlistScreenController.allSongsListModel!.data![controller.currentListTileIndex.value].title == artistScreenController.allSongsListModel!.data![index].title && playlistScreenController.allSongsListModel != null) ||
                                                              (controller.isMiniPlayerOpenHome.value == true && homeScreenController.homeCategoryData[controller.currentListTileIndexCategory.value].categoryData[controller.currentListTileIndexCategoryData.value].title == artistScreenController.allSongsListModel!.data![index].title && homeScreenController.homeCategoryData.isNotEmpty) ||
                                                              (controller.isMiniPlayerOpenFavoriteSongs.value == true && favoriteSongScreenController.allSongsListModel!.data!.isNotEmpty && favoriteSongScreenController.allSongsListModel != null && favoriteSongScreenController.allSongsListModel!.data![controller.currentListTileIndexFavoriteSongs.value].title == artistScreenController.allSongsListModel!.data![index].title) ||
                                                              (controller.isMiniPlayerOpenQueueSongs.value == true && queueSongsScreenController.allSongsListModel!.data![controller.currentListTileIndexQueueSongs.value].title == artistScreenController.allSongsListModel!.data![index].title && queueSongsScreenController.allSongsListModel != null) ||
                                                              (controller.isMiniPlayerOpenAllSongs.value == true && allSongsScreenController.allSongsListModel != null && allSongsScreenController.allSongsListModel!.data![controller.currentListTileIndexAllSongs.value].title == artistScreenController.allSongsListModel!.data![index].title)) &&
                                    ...
                                    () => lable(
                                      ...
                                      color: (controller.isMiniPlayerOpenDownloadSongs.value == false &&
                                              ...
                                              controller.isMiniPlayerOpenQueueSongs.value ==
                                                  false)
                                          ? AppColors.white
                                          : ((controller.isMiniPlayerOpenArtistSongs.value == true &&  artistScreenController.allSongsListModel != null && artistScreenController.currentPlayingTitle.value == artistScreenController.allSongsListModel!.data![index].title) ||
                                                  (controller.isMiniPlayerOpenAlbumSongs.value == true &&
                                                      albumScreenController.currentPlayingTitle.value ==
                                                          artistScreenController
                                                              .allSongsListModel!
                                                  ...
                                                  (controller.isMiniPlayerOpenDownloadSongs.value == true &&
                                                      downloadSongScreenController
                                                              ...
                                                              .title ==
                                                          artistScreenController.allSongsListModel!.data![index].title &&
                                  ...
                                  subtitle: lable(
                                      text: (artistsSongsData.description)!,
                                      fontSize: 11,
                                      color: Colors.grey),
                                ),
                                sizeBoxHeight(10),
