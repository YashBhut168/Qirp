                                ...
                                detailScreenController
                                    ...
                                    : ListView.builder(
                                        ...
                                        itemBuilder: ((context, index) {
                                          ...
                                          if (kDebugMode) {
                                            print(
                                                "filterImage ---> ${detailScreenController.filteredPlaylisImages}");
                                          }
                                          if (kDebugMode) {
                                            print(
                                                "filteredPlaylistTitles ---> ${detailScreenController.filteredPlaylistTitles}");
                                          }
                                          ...
                                          return ListTile(
                                            ...
                                            onTap: () {
                                              setState(() { 
                                                GlobVar.adminOrUserPlaylist = 'user';
          ...
          child: Padding(
            ...
            child: Scaffold(
              ...
              floatingActionButton: Container(
                ...
                child: detailScreenController
                        .filteredPlaylisImages[index].isEmpty
                    ? Container(
                        height: 150,
                        width: 150,
                    ...
                    : detailScreenController
                                .filteredPlaylisImages[index].length ==
                            4
                        ? SizedBox(
                            height: 150,
                            width: 150,
                            child: GridView.builder(
                              ...
                              itemBuilder: (context, imageIndex) {
                                return Image.network(
                                  detailScreenController
                                      .filteredPlaylisImages[index][imageIndex],
                                  // height: 15,
                                  // width: 15,
                                );
                              },
