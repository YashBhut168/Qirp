    ...
    return Scaffold(
      ...
      body: Obx(
        ...
        //         downloadSongScreenController.allSongsListModel == null
            ...
            : downloadSongScreenController.allSongsListModel == null ? Center(child: lable(text: 'No Downloads'),) : SingleChildScrollView(
                    ...
                    children: [
                      ...
                      ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final localFilePath =
                                    '${AppStrings.localPathMusic}/${downloadSongScreenController
                            ...
                            controller.downloadSongsUrl =
                                controller.downloadSongsUrl.toSet().toList();
                            log("${controller.downloadSongsUrl}");
                              ...
                              onTap: () async {
                                setState(() {
                                  ...
                                  controller.isMiniPlayerOpenAllSongs.value =
                                      false;
                                  controller.currentListTileIndexDownloadSongs
                                      .value = index;
                                  controller
                                  ...
                                  homeScreenController.addRecentSongs(musicId: downloadSongListData.id!);
                              },
